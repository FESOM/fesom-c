...
!   real(wp), allocatable, save, dimension(:,:), public, target     :: qsr3d   ! downward solar heat over the ocean [W/m2] downwelling_photosynthetic_radiative_flux
...
!      namelist/nam_sbc/ nm_sbc, nm_tauwind, nm_xwind0, nm_ywind0,  &
